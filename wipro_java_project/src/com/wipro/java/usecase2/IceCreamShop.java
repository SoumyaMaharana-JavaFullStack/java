...
class ConeIceCream extends IceCream {
	...
	public void showDetails() {
		System.out.println("Cone Ice Cream - Flavor: " + getFlavor() + " - Price: " + getPrice() + " - Size: "
				+ getSize() + " - Cone Type: " + coneType);
	}
}
...
class CupIceCream extends IceCream {
	...
	@Override
	public void showDetails() {
		System.out.println("Cup Ice Cream - Flavor: " + getFlavor() + " - Price: " + getPrice() + " - Size: "
				+ getSize() + " - Topping: " + topping);
	}
}
...
public class IceCreamShop {
	public static void main(String[] args) {
		...
		// Using Streams & Lambda to Filter Ice Creams with Price > Rs.4
		System.out.println("Ice Creams priced above Rs.4.00:");
		iceCreamList.stream().filter(i -> i.getPrice() > 4).forEach(IceCream::showDetails);
		...
		iceCreamList.stream().sorted(Comparator.comparingDouble(IceCream::getPrice)).forEach(IceCream::showDetails);
	}
}
